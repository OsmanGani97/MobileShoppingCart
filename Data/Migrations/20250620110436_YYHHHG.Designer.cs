...
namespace DMobileSite.Data.Migrations
{
    ...
    [Migration("20250620110436_YYHHHG")]
    partial class YYHHHG
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DMobileSite.Models.Hardware_SoftWare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hardware_SoftWareMobile", b =>
                {
                    b.Property<int>("Hardware_SoftWareId")
                        .HasColumnType("int");

                    b.Property<int>("MobileId")
                        .HasColumnType("int");

                    b.HasKey("Hardware_SoftWareId", "MobileId");

                    b.HasIndex("MobileId");

                    b.ToTable("Hardware_SoftWareMobile");
                });
            ...
            modelBuilder.Entity("Hardware_SoftWareMobile", b =>
                {
                    b.HasOne("DMobileSite.Models.Hardware_SoftWare", null)
                        .WithMany()
                        .HasForeignKey("Hardware_SoftWareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMobileSite.Models.Mobile", null)
                        .WithMany()
                        .HasForeignKey("MobileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
