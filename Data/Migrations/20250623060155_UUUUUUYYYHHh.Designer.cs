...
namespace DMobileSite.Data.Migrations
{
    ...
    [Migration("20250623060155_UUUUUUYYYHHh")]
    partial class UUUUUUYYYHHh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DMobileSite.Models.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DMobileSite.Models.Stock", b =>
                {
                    b.HasOne("DMobileSite.Models.Mobile", "Mobile")
                        .WithOne("Stock")
                        .HasForeignKey("DMobileSite.Models.Stock", "MobileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
